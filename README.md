...
Este repositorio está basado en el repositorio de [Allison Thackston](https://github.com/athackst/vscode_ros2_workspace), con unas minimas modificaciones. 

Hay que instalar VcXsrv para windows y setear en 0 el numero de ventanas.
